...
namespace AbmsgModel
{
    ...
    {
        private AbmsgDbContext DbContext { get; set; }
        protected IRepositoryProvider RepositoryProvider { get; set; }
        public INewsRepository News { get { return GetRepo<INewsRepository>(); } }
        ...
        public Uow(IRepositoryProvider repositoryProvider, AbmsgDbContext dbContext)
        {
        ...
        protected void CreateDbContext(AbmsgDbContext dbContext)
        {
            DbContext = (dbContext == null ? new AbmsgDbContext() : dbContext);
