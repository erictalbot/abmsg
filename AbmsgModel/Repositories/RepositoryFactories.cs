...
{   /// <summary>
    /// A maker of SimpleTaskData Repositories.
    /// </summary>
    /// <remarks>
    ...
    {
        /// <summary>
        /// Return the runtime SimpleTaskData repository factory functions,
        /// each one is a factory for a repository of a particular type.
        /// </summary>
        /// <remarks>
        /// </remarks>
        private IDictionary<Type, Func<DbContext, object>> GetSimpleTaskDataFactories()
        {
            return new Dictionary<Type, Func<DbContext, object>>
            {
                {typeof(INewsRepository), DbContext => new NewsRepository(DbContext)}
            };
        }

        /// <summary>
        /// Constructor that initializes with runtime SimpleTaskData repository factories
        /// </summary>
        public RepositoryFactories()
        {
            _repositoryFactories = GetSimpleTaskDataFactories();
        }
        ...
        /// </remarks>
        public Func<DbContext, object> GetDefaultOrExistingRepositoryFactoryForEntityType<T>() where T : class
        {
        ...
        {
            return dbContext => new DefaultRepository<T>(dbContext);
        }
